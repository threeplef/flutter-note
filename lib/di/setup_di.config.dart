...
_i1.GetIt $initGetIt(
  ...
  gh.singleton<_i13.UseCases>(_i13.UseCases(
    addNoteUseCase: get<_i9.AddNoteUseCase>(),
    deleteNoteUseCase: get<_i10.DeleteNoteUseCase>(),
    getNoteUseCase: get<_i11.GetNoteUseCase>(),
    getNotesUseCase: get<_i12.GetNotesUseCase>(),
    updateNoteUseCase: get<_i7.UpdateNoteUseCase>(),
  ));
